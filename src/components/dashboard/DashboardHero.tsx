...
export function DashboardHero({ teamName, badgeId, level, xp, onEditProfile }: DashboardHeroProps) {
  // Overriding values for high-fidelity reference as requested
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-center justify-between gap-12">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16 flex-1">
          ...
          <div className="relative group">
            ...
            <div className="w-48 h-56 lg:w-60 lg:h-72 shield-shape glass-premium flex items-center justify-center p-10 border-gold/40 relative z-10 shadow-[0_30px_60px_rgba(0,0,0,0.7)] group-hover:border-gold transition-all duration-500">
               <div className="relative w-full h-full flex items-center justify-center">
                  <img 
                    src="/assets/logo.png" 
                    className="w-full h-auto object-contain glow-gold-strong drop-shadow-[0_20px_40px_rgba(0,0,0,0.6)] mb-6 opacity-40 grayscale" 
                    alt="Team Badge Base" 
                  />
                  {/* The "V" or Custom Badge Content */}
               ...
               <button 
                 ...
                 className="absolute inset-0 flex items-center justify-center bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-30"
               >
                  <div className="bg-gold text-black px-4 py-2 rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl">
                    MODIFICA PROFILO
                  </div>
               </button>
          ...
          <div className="text-center lg:text-left space-y-5 flex-1 min-w-0">
            ...
            <button
              onClick={onEditProfile}
              className="group flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.3em] text-white/40 hover:text-white transition-all duration-300"
            >
        ...
        <div className="hidden xl:block">
          <div className="glass-premium p-10 w-80 space-y-8 relative overflow-hidden border-gold/20 shadow-2xl rounded-[2.5rem]">
             ...
             <div className="flex items-center gap-6 relative z-10">
                <div className="w-20 h-20 rounded-2xl bg-gold/10 border border-gold/30 flex items-center justify-center text-4xl shadow-inner">
                   🏆
                </div>
                <div>
             ...
             <div className="pt-6 relative z-10">
                ...
                <div className="text-3xl font-black italic text-emerald-400 tracking-tighter drop-shadow-[0_0_15px_rgba(52,211,153,0.4)]">
                  23G 14H 32M
                </div>
             </div>
          </div>
