...
export default function ResultsPage() {
  ...
  }, [currentMatch, clearMatch, router]);
    ...
    <AnimatePresence>
      {!redirecting && (
        <motion.div 
          ...
          className="flex-1 flex items-center justify-center px-4 lg:px-8 py-8 lg:py-12 bg-surface"
        >
          <div className="w-full max-w-lg space-y-6 lg:space-y-8">
            ...
            <div className="text-center space-y-3">
              <p className="text-[10px] uppercase font-black tracking-[0.2em] text-muted/60">Ritorno alla base tra pochi istanti...</p>
